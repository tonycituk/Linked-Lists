...
public class LinkList<T>{
    ...
    //Método que devuelva el primer elemento de la lista (solo lo devuelve, no lo elimina de la lista)
    /**
     * <p>
     * Este método regresa el nodo correspondiente a la primera posición de la lista.
     * </p>
     * 
     * @return El primer nodo de la lista si es que no está vacía, null en caso contrario.
     * 
     */
    public Link<T> first(){ 
        return first;
     ...
     * </p>
     * 
     * @return El último nodo de la lista si es que no está vacía, null en caso contrario.
     * 
     */
    public Link<T> last(){ 
        if(isEmpty()){
     ...
     * </p>
     * 
     * @return Un entero que representa la cantidad de elementos almacenados en la lista.
     * 
     */
    public int getSize(){
        int size = 0;
     ...
     * </p>
     * 
     * @param objRef El dato existente en alguno de los nodos de la lista, que servirá de referencia para insertar después.
     * @param objNew El nuevo dato que se asignará a un nuevo nodo que será insertado después del nodo de referencia.
     * 
     */
    ...
    //Método para insertar elemento en forma ordenada a. Creciente SOLO CONSIDERAR DATOS NUMÉRICOS
    /**
     * <p>
     ...
     * </p>
     * 
     * @param dato El dato que se asignará al nuevo nodo y será colocado en una posición ordenada en la lista.
     * 
     */
    public void insertCrescent(T dato){
        ...
        try{
            if (first == null || 0 <= (first.getDato().toString().compareTo(newLink.getDato().toString())))
            {
                ...
                Link<T> temp = first;
                while (temp.getNext() != null && 0 < (newLink.getDato().toString().compareTo(temp.getNext().getDato().toString()))){
                   // temp2 = temp;
                    temp = temp.getNext();
                }
    ...
    //Método para insertar elemento en forma ordenada b. Decreciente SOLO CONSIDERAR DATOS NUMÉRICOS SUPONER QUE LA LISTA ESTÁ ORDENADA
    /**
     * <p>
     ...
     * </p>
     * 
     * @param data El dato existente en alguno de los nodos de la lista, que servirá para buscar el nodo a eliminar.
     * 
     */
    public void deleteWhere(Object data) throws ExcepcionDynamicList{
        boolean eliminado = false;
        if(first.getDato().toString().equals(data)){
            try{
                deleteFirst();
     ...
     * </p>
     * 
     * @param posDel El entero que representa la posición del nodo que se desea eliminar.
     * 
     */
    ...
    //Método para hacer una búsqueda de un elemento y devolver -1 si no lo encontró y la posición del dato en la lista en caso de que se haya encontrado
    /**
     * <p>
     ...
     * </p>
     * 
     * @param data El dato que servirá de referencia para buscar si en la lista se encuentra algún nodo que contenga dicho dato.
     * @return Un entero que representa la posición del nodo donde se encontró el dato en la lista. Si regresa -1 indica que no se encontró un nodo con dicho dato
     */
     ...
     * </p>
     * 
     * @param pos El entero que representa la posición del nodo que se desea sustituir.
     ...
     * </p>
     * 
     * @return El nodo que anteriormente a la eliminación ocupaba la última posición de la lista.
     * 
     */
     ...
     * </p>
     * 
     * @return El nodo que anteriormente a la eliminación ocupaba la primera posición de la lista.
     * 
     */
